        ...
        {projects.length > 0 && frameworks.length > 0 && (
          <main className="pt-5">
            <Switch>
              ...
              />
              <Route
                path="/alerts?id=:id&status=:status&framework=:framework&filter=:filter&hideImprovements=:hideImprovements&hideDwnToInv=:hideDwnToInv&filterText=:filterText&page=:page"
                render={props => (
                  <AlertsView
                    {...props}
                    user={user}
